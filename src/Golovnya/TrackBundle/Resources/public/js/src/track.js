...
var TrackTable = React.createClass({
    ...
    render: function () {
        ...
        if (rows.length) {
            rows.splice(0, 0, React.createElement(PlaylistRow, {
...
var FilterableTrackTable = React.createClass({
    displayName: "FilterableTrackTable",
    getInitialState: function () {
        return {
            playlist: {id: "0", name: ''},
            filterTrack: '',
